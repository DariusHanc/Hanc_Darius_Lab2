...
namespace Hanc_Darius_Lab2.Models
{
    public class BookCategoriesPageModel :PageModel
    {
        ...
        public void PopulateAssignedCategoryData(Hanc_Darius_Lab2Context context,
        Bookcs book)
        {
        ...
        public void UpdateBookCategories(Hanc_Darius_Lab2Context context,
        string[] selectedCategories, Bookcs bookToUpdate)
        {
